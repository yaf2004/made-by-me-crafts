...
export const packages = [
  ...
  },
  {
    ...
    description:
      "Arrange fresh edible flowers and herbs into a beautiful bouquet — gorgeous enough to photograph, delicious enough to enjoy.",
    duration:    "Open session",
  ...
  },
  {
    ...
    description:
      "Twist and shape chenille pipe cleaners into colourful blooms that never wilt. A joyful, tactile craft that's surprisingly addictive.",
    duration:    "Open session",
    materials:   ["Pipe cleaners (rainbow pack)", "Wire stems", "Floral tape"],
    skillLevel:  "Beginner-friendly",
    prices: [
      { label: "40 - 100 birr depending on the size per 1 flower", amount: null },
    ],
